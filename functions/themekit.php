 ...
 * @since 			1.0.0
 * @package 		Workforce
 * @subpackage 		Workforce/functions
 */
 ...
 */
function workforce_camelcase( $word, $separator ) {
 ...
 */
function workforce_categorized_blog() {

	$cats_count = get_transient( 'workforce_categories' );
	...
	if ( false === ( $cats_count ) ) {
		...
		set_transient( 'workforce_categories', $cats_count );
 ...
 */
function workforce_get_attachment_by_name( $post_name ) {
	...
	/**
	 * The workforce_get_attachment_by_name_args filter.
	 */
	$args 	= apply_filters( 'workforce_get_attachment_by_name_args', $args );
...
} // workforce_get_attachment_by_name()
 ...
 */
function workforce_get_max( $array ) {
 ...
 */
function workforce_get_page_id_by_slug( $slug, $post_type = 'page' ) {
 ...
 */
function workforce_get_posts( $post, $params = array(), $cache = '' ) {
 ...
 */
function workforce_get_posts_page() {
 ...
 */
function workforce_get_state_abbreviation( $state ) {
	...
	/**
	 * The workforce_get_state_abbr filter.
	 */
	$states = apply_filters( 'workforce_get_state_abbr', $states );
...
} // workforce_get_state_abbreviation()
 ...
 */
function workforce_get_state_name( $state ) {
	...
	/**
	 * The workforce_get_state_name filter.
	 */
	$states = apply_filters( 'workforce_get_state_name', $states );
 ...
 */
function workforce_is_tree( $pageID ) {
 ...
 */
function workforce_make_map_link( $address ) {
 ...
 */
function workforce_make_phone_link( $number ) {
	...
	$return .= esc_html__( 'Call ', 'workforce' ) . '</span>';
	$return .= $number . '</a>';
	$return .= '</span>';

	return $return;

} // workforce_make_phone_link()
 ...
 */
function workforce_shorten_text( $text, $limit = 100, $after = '...' ) {
