...
class workforce_Slushicons {
	...
	public function hooks() {
		...
		add_filter( 'workforce_menu_item_icon_name', 		array( $this, 'get_icon_info' ), 10, 3 );
		add_filter( 'workforce_menu_item_text_position', 	array( $this, 'get_text_position' ), 10, 3 );
		add_filter( 'workforce_change_svg', 					array( $this, 'change_default_svgs' ), 10, 1 );
	...
	*/
	public function add_icons_to_menu( $title, $item, $args, $depth ) {
		...
		$icon_name 	= apply_filters( 'workforce_menu_item_icon_name', '', $item, $args );
		$icon 		= $this->get_icon( $icon_name );
		$textpos 	= apply_filters( 'workforce_menu_item_text_position', '', $item, $args );
	 ...
	 * @hooked 		workforce_menu_item_icon_name 		10
	 ...
	 *
	 * @exits 		If $classes is empty.
	 * @hooked 		workforce_menu_item_text_position 		10
