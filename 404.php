...
?><div id="primary" class="content-area">
	<main id="main" role="main">
		<section class="error-404 not-found"><?php
			...
			/**
			 * The workforce_404_content action hook
			 *
			 * @hooked 		title_404 		10
			 */
			do_action( 'workforce_404_before' );
			...
			?><div class="page-content"><?php
				 ...
				 */
				do_action( 'workforce_404_content' );

			?></div><!-- .page-content --><?php

			/**
			 * The workforce_404_after action hook
			 */
			do_action( 'workforce_404_after' );
